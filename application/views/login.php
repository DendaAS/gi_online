...
<head>
    ...
    <title>Login Aplikasi General Item</title>
    <title>PRODUCTION SUPPORT</title>
    <link rel="shortcut icon" href="<?= base_url('assets/img/favicon1.ico'); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/icon.jpg'); ?>" class="login" />
                <h3 class="text-white mt-2">Aplikasi General Item</h3>
